export default async function handler(req, res) {
    ...
    const { path: apiPath, ...otherParams } = req.query;
    ...
    // Reconstrói query string com todos os parâmetros exceto 'path'
    const urlParams = new URLSearchParams();

    // Adiciona todos os parâmetros exceto 'path'
  ...
  const targetUrl = `https://api.intra.42.fr/${apiPath}${finalQuery}`;    // Forward headers
